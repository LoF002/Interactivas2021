    ...
    methods: {
        ...
        confirm() {
            ...
            for (let i = 0; i < this.tickets.length; i++) {
                cantidad = this.tickets[i].qty;
                titulo += this.events[this.tickets[i].event].title + "/";
            }
